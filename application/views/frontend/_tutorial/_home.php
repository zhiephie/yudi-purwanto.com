...
<div id="grid">
<?php
foreach($tutorial->result() as $value)
{
	$date = generate_tanggal($value->date);
	$isi = strip_tags(substr($value->text ,0,250));
	$pecah = explode(".", $value->image);
	$alt = $pecah[0];
?>
	<div id="post-<?php echo $value->idtutorial; ?>" class="col-md-6">
		<div class="article-grid">
			<a class="article-img" href="<?php echo base_url(); ?>show/detail/<?php echo $value->slug; ?>"><img width="1200" height="500" src="<?php echo base_url(); ?>assets/uploads/thumb/<?php echo $value->image; ?>" class="img-responsive wp-post-image" alt="<?php echo $alt; ?>"/></a>
	...
	<a href="<?php echo base_url(); ?>show/detail/<?php echo $value->slug; ?>#comment-section"><span class="dsq-postid" rel="<?php echo $value->idtutorial; ?> <?php echo base_url(); ?>show/detail/<?php echo $value->slug; ?>">16 Comments</span></a></span>
