...
?>
	...
	<a href="<?php echo base_url(); ?>show/detail/<?php echo $value->slug; ?>#comment-section"><span class="dsq-postid" rel="<?php echo $value->idtutorial; ?> <?php echo base_url(); ?>show/detail/<?php echo $value->slug; ?>"> Comments</span></a></span>
