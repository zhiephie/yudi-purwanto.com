      	...
      	<div class="col-md-12">   		
      		<div class="widget stacked">
				...
				$attributes = array('class' => 'form-horizontal col-md-7', 'id' => '');
      			...
      			echo form_open_multipart('backend/category', $attributes);
      			?>
				    <br/>
						<fieldset>
					...
					<table class="table table-striped table-bordered">
				        ...
				        ?>
			        		 <tr>
								...
								<td> <?php echo $t->slug_cat;?></td>
								<td class='td-actions'>
								<a href="<?php echo base_url();?>backend/editcateg/<?php echo $t->idcategorytutorial;?>" data-toggle='tooltip' data-placement='top' title='' data-original-title='Edit' class='btn btn-sm btn-default ui-tooltip'>
								  <i class='btn-icon-only icon-edit'></i>					
								</a>
								</td>
								<td class='td-actions'>
								<a href="<?php echo base_url();?>backend/destroy_cat/<?php echo $t->idcategorytutorial;?>" 
